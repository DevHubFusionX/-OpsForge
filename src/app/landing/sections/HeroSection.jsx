...
export const HeroSection = () => {
  return (
    <section className="relative pt-22 pb-20 px-6 bg-gradient-to-b from-white via-gray-50/50 to-white overflow-hidden">
      ...
      {/* Gradient Orbs */}
      <motion.div 
        className="absolute top-0 left-1/4 w-96 h-96 bg-[#38BDF8]/5 rounded-full blur-3xl"
        animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
      />
      <motion.div 
        className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#38BDF8]/5 rounded-full blur-3xl"
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            <a
              href="/auth/register"
              className="group px-8 py-4 bg-black text-white font-semibold text-lg rounded-full hover:bg-gray-900 hover:shadow-2xl hover:scale-105 active:scale-95 transition-all duration-200 flex items-center gap-2"
            >
              Get Started Free
            ...
            <a
              href="/demo"
              className="px-8 py-4 bg-white text-black font-semibold text-lg rounded-full border-2 border-gray-200 hover:border-[#38BDF8] hover:shadow-xl active:scale-95 transition-all duration-200"
            >
              Watch Demo
            </a>
          </motion.div>
